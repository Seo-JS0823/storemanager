...
public class BillDTO {
	...
	public String getGbc_gi_name() {
		return gbc_gi_name;
	}

	public void setGbc_gi_name(String gbc_gi_name) {
		this.gbc_gi_name = gbc_gi_name;
	}

	public String getGbc_gcm_name() {
		return gbc_gcm_name;
	}

	public void setGbc_gcm_name(String gbc_gcm_name) {
		this.gbc_gcm_name = gbc_gcm_name;
	}

	public String getGbc_inout() {
		return gbc_inout;
	}

	public void setGbc_inout(String gbc_inout) {
		this.gbc_inout = gbc_inout;
	}
	...
	public BillDTO(int gih_idx, String gcm_code, int gi_code, String gi_name, String gih_inout, String gih_qty,
			...
			String gbc_gis_list, String gbc_gi_name, String gbc_gcm_name, String gbc_inout, String gbc_regdate,
			String gcm_name, String amount, int num) {
		super();
		this.gih_idx = gih_idx;
		this.gcm_code = gcm_code;
		this.gi_code = gi_code;
	...
	public String toString() {
		return "BillDTO [gih_idx=" + gih_idx + ", gcm_code=" + gcm_code + ", gi_code=" + gi_code + ", gi_name="
				...
				+ ", gbc_gi_name=" + gbc_gi_name + ", gbc_gcm_name=" + gbc_gcm_name + ", gbc_inout=" + gbc_inout
